  ...
  (
    {
      ...
      nixComponents_2_29 = nixDependencies.callPackage ./modular/packages.nix {
        ...
        src = fetchFromGitHub {
          ...
          repo = "nix";
          tag = "2.29.3";
          hash = "sha256-VCTBvh03DZ9ygqrD5CoeqIg/ja0/EvecQ9aKADCw3FQ=";
        };
      };
      ...
      nixComponents_git = nixDependencies.callPackage ./modular/packages.nix rec {
        version = "2.31.0pre20250711_${lib.substring 0 8 src.rev}";
        inherit (self.nix_2_24.meta) maintainers teams;
        otherSplices = generateSplicesForNixComponents "nixComponents_git";
        src = fetchFromGitHub {
          owner = "NixOS";
          repo = "nix";
          rev = "ab3cd76e73879b9a609972f29919a48144f9336f";
          hash = "sha256-5ZXs5QHwrT5Ouy0ynZ7e7R+3z9ovLTwUX5xGAfUUIRo=";
        };
      };
