...
let
  ...
  common = rec {
    ...
    src = fetchurl {
      url = "https://downloads.percona.com/downloads/Percona-Server-${lib.versions.majorMinor version}/Percona-Server-${version}/source/tarball/percona-server-${version}.tar.gz";
    ...
    passthru = {
      mysqlVersion = lib.versions.majorMinor version;
    };
