{
  ...
  discourse_ai-tokenizers = {
    dependencies = ["activesupport" "tiktoken_ruby" "tokenizers"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  rubocop-discourse = {
    dependencies = ["activesupport" "lint_roller" "rubocop" "rubocop-capybara" "rubocop-factory_bot" "rubocop-rails" "rubocop-rspec" "rubocop-rspec_rails"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  zeitwerk = {
    groups = ["default" "development" "migrations" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
